...
export async function generateMetadata({ params }) {
  ...
  return {
    ...
    alternates: {
      canonical: `https://alkemeins.com/entertainment/blog/${post.slug}/`,
    },
    openGraph: {
      title: `${post.metaTitle} | ALKEME Insurance Services`,
      description: post.metaDescription,
      url: `https://alkemeins.com/entertainment/blog/${post.slug}/`,
      type: 'article',
    },
  };
}
  ...
  const jsonLd = [
    {
      ...
      description: post.metaDescription,
      url: `https://alkemeins.com/entertainment/blog/${post.slug}/`,
      mainEntityOfPage: `https://alkemeins.com/entertainment/blog/${post.slug}/`,
    },
    ...(post.faqs?.length ? [{
      '@context': 'https://schema.org',
      '@type': 'FAQPage',
