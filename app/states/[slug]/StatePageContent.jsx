  ...
  return (
    <div ref={ref} className="bg-stone fade-in-view" style={{ padding: '4rem 0' }}>
      <div className="max-w-[68rem] mx-auto px-[60px] max-lg:px-6 max-md:px-4">
        <h2 className="text-brand font-bold leading-[1.3] tracking-tight mb-6" style={{ fontSize: '1.5rem' }}>Entertainment Insurance in Nearby States</h2>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div>
            ...
            <div className="space-y-2">
              {['general-liability', 'production-insurance', 'event-cancellation', 'equipment-floater', 'workers-compensation'].map(slug => (
          ...
          <div>
            ...
            <div className="space-y-2">
              {[
                { slug: 'entertainment-insurance-cost', label: 'How Much Does Entertainment Insurance Cost?' },
                { slug: 'production-insurance-guide', label: 'Production Insurance Guide' },
                { slug: 'event-cancellation-guide', label: 'Event Cancellation Guide' },
                { slug: 'venue-liability-guide', label: 'Venue Liability Guide' },
              ].map(r => (
        ...
        <section className="bg-stone" style={{ padding: '5rem 0' }}>
          <div className="max-w-[900px] mx-auto px-[60px] max-lg:px-6 max-md:px-4">
            <h2 className="text-brand font-bold leading-[1.3] tracking-tight mb-8 text-center" style={{ fontSize: 'clamp(1.8rem, 3vw, 2.2rem)' }}>
              Entertainment Insurance FAQ — {state.name}
            </h2>
