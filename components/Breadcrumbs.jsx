    ...
    <>
      ...
      <div className="bg-brand/5 border-b border-ash">
        <div className="max-w-[68rem] mx-auto px-[60px] max-lg:px-6 max-md:px-4 py-2 flex flex-wrap items-center justify-between gap-2">
          <p className="text-brand/50" style={{ fontSize: '0.7rem' }}>Published by <strong className="text-brand/70">ALKEME Insurance Services</strong> · Licensed Insurance Brokerage · Est. 2003</p>
          <p className="text-brand/40" style={{ fontSize: '0.65rem' }}>Last updated April 2026</p>
        </div>
      </div>
    </>
  );
